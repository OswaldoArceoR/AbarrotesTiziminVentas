...
CSV_FILE = os.path.join(os.path.dirname(__file__), "datos_articulos.csv")
...
class PaginaPrincipal(QWidget):
    ...
    def abrir_articulos(self):
        ...
        # Cargar datos desde el archivo CSV al abrir la ventana
    ...
    def guardar_datos_csv(self):
        """ Guarda los datos de los artículos en un archivo CSV """
        with open(CSV_FILE, mode="w", newline="", encoding="utf-8") as file:
            writer = csv.writer(file)
            writer.writerow(["ID", "Nombre", "Precio Público", "Precio Proveedor", "Stock"])  # Encabezados
            for articulo in self.lista_articulos:
                writer.writerow([
                    articulo["id"],
                    articulo["nombre"],
    ...
    def cargar_datos_csv(self):
        ...
        with open(CSV_FILE, mode="r", encoding="utf-8") as file:
            ...
            self.lista_articulos = []  # Limpiar la lista antes de cargar
        ...
        self.actualizar_tabla_articulos()  # Mostrar los datos en la tabla
